      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-10">
        ...
        <div className="bg-white p-4 rounded-xl shadow-sm border border-slate-100 flex flex-col lg:flex-row gap-4 mb-10">
          <div className="flex-1 relative">
            ...
            <input 
              ...
              className="w-full pl-10 pr-4 py-3 rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all bg-slate-50"
              value={searchTerm}
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <select 
              className="px-4 py-3 rounded-lg border border-slate-200 bg-slate-50 focus:outline-none focus:ring-2 focus:ring-primary text-slate-700 font-medium"
        ...
        {isLoading ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[1, 2, 3, 4, 5, 6].map(i => (
              <div key={i} className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 flex flex-col h-[320px]">
                <div className="flex gap-4 mb-4">
                  ...
                  <div className="flex-1 space-y-3 py-2">
                    ...
                    <div className="h-6 bg-slate-200 rounded-full animate-pulse w-1/2"></div>
